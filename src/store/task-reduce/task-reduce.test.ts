...
test('should remove task',()=>{
    ...
    const endState = taskReducer(todoTasks,removeTaskAC(IdForThirdTodoList,id));
...
const titleNewTask = 'new title';
    ...
    const endState = taskReducer(todoTasks,addTaskAC(IdForSecondTodoList,titleNewTask));
...
test('should change task isDone status',()=>{
    ...
    const endState = taskReducer(todoTasks,changeStatusTaskAC(IdForFirstTodoList,id,true));
...
test('should change task title',()=>{
   ...
   const newTitle = 'new our title'
    ...
    const endState = taskReducer(todoTasks,changeTitleTaskAC(IdForSecondTodoList,id,newTitle));
...
test('should delete tasks by ID TodoLists ',()=>{
    ...
    const endState = taskReducer(todoTasks,removeTodoListAC(IdForFirstTodoList));
...
const endStateNewTodoListTasks = taskReducer(todoTasks,action);
...
const endState = taskReducer(todoTasks,removeAllTasksAC(IdForSecondTodoList));
