...
type PropsType = {
    ...
    changeTitleTodoList:(idTodoList:string,newTitle:string)=>void,
}
...
export const Todolist: FC<PropsType> = ({
    ...
    return <div>
        <FlexWrapper>
            <TodoTitle>
                {/*isActiveOnBlur*/}
                { editMode ? <AddItemForm autoFocus defaultValue={title}  callBack={changeTitleInThisTODO}/>:<h3 onDoubleClick={()=>{setEditMode(true)}}>{title}</h3>}
            </TodoTitle>
